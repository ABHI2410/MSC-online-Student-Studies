        ...
        <Grid container spacing={2}>
          ...
          <Grid item xs={12} sm={12}>
            <Autocomplete
              ...
              renderInput={(params) => (
                <TextField {...params} label="Programs" name="program_id" />
              )}
            />
          </Grid>
          <Grid item xs={12} sm={6}>
